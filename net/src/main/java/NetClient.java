import handler.MyPacketHandler;
import jpize.Jpize;
import jpize.gl.Gl;
...
public class NetClient extends JpizeApplication implements TcpListener{
    
    public static void main(String[] args){
        ContextBuilder.newContext(1280, 720, "Net - client")
                .register()
                .setAdapter(new NetClient());
    ...
    public void render(){
        ...
        batch.drawQuad(0.1, 0.15, 0.2, 1,  50, 10, bounds.x, lineAdvance);
        batch.drawQuad(0.3, 0.45, 0.5, 1,  0, 10, 50, lineAdvance);
        ...
        if(text.isCursorRender()){
            ...
            batch.drawQuad(1, 1, 1, 1,  50 + cursorX, 10, 2, lineAdvance);
        }
