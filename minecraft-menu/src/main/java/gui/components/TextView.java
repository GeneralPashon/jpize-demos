...
public class TextView extends MComponent{
    ...
    private gui.text.Component text;
    ...
    public TextView(Session session, gui.text.Component text){
    ...
    public void correctPos(){
        ...
        if(scissor && parent != null && (widthDifference = width - parent.getWidth()) > 0){
            ...
            final float increment = Jpize.getDt() * parent.getWidth() * widthDifference / 5000;
    ...
    public void render(TextureBatch batch, float x, float y, float width, float height){
        ...
        for(TextComponent textComponent: components){
            ...
            gui.text.formatting.Style style = textComponent.getStyle();
    ...
    public gui.text.Component getText(){
        return text;
    }
