...
public class Physic extends JpizeApplication{

    public static void main(String[] args){
        ContextBuilder.newContext(1280, 720, "Physic")
                .register()
                .setAdapter(new Physic());
        Jpize.runContexts();
    }
    ...
    @Override
    public void render(){
        Jpize.window().setTitle("Physic (fps: " + Jpize.getFPS() + ")");
